...
plt.ylim([0, .4])
plt.legend()
plt.savefig("binary_train_loss_stopping=%s_epochs=%s.png" % (with_stopping, str(num_epochs)))
plt.show()
...
plt.legend()
plt.savefig("binary_train_accuracy_stopping=%s_epochs=%s.png" % (with_stopping, str(num_epochs)))
plt.show()
